...
public class MessageCollection
{
    public MessageCollection(MessageCollection messageCollection)
    {
        ...
        MessageContent = messageCollection.MessageContent;
        FilePaths = messageCollection.FilePaths;
        ReplyMessage = messageCollection.ReplyMessage;
        VoiceMessageDuration = messageCollection.VoiceMessageDuration;
    }
