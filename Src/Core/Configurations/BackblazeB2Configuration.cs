...
{
    public static IServiceCollection ConfigureBackblazeB2(this IServiceCollection services,
        IConfiguration configuration)
    {
        ...
        UploadToStoreS3.BackblazeB2Service.InitBackblazeB2Service(b2Client, options.KeyId, options.ApplicationKey,
            options.BucketId, options.BucketName);
